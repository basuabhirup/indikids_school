...
export function Footer() {
  return (
    <footer
      id="footer"
      className="bg-slate-900 text-white pt-20 pb-10 text-center md:text-left"
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-400">
              Where kids learn to be illuminated. A premium English medium
              primary school committed to a fearless, homely learning
              environment.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 flex flex-col items-center md:items-start">
              <div className="flex items-start gap-3 text-slate-400">
                ...
                <span>
                  Rathtala, Lalpur, P.O. Chakdaha, District- Nadia. PIN- 741222.
                  West Bengal, India.
                </span>
              </div>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-slate-500 text-sm">
          <p>
            &copy; {new Date().getFullYear()} INDIKIDS. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
